    ...
    <div className="modal-bg" onClick={onFechar}>
      <div className="modal" onClick={e => e.stopPropagation()} style={{maxHeight:'80vh',overflowY:'auto',maxWidth:'420px'}}>
        ...
        <div style={{fontSize:'12px',color:'var(--texto)',lineHeight:1.8}}>
          ...
          <p style={{marginBottom:'1rem'}}>
            Os seus dados não são partilhados com terceiros para fins comerciais. Utilizamos o serviço Supabase (UE) para armazenamento seguro dos dados.
          </p>
          ...
          <p style={{marginBottom:'1rem'}}>
            Para exercer os seus direitos, contacte-nos através de: <strong>fisioreis2019@gmail.com</strong>
          </p>
